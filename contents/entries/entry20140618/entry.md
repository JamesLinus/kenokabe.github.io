...
##数学的実体である「時間」を数学的実体である「プログラミングコード」でモデリングすることは可能

「時間」とは物理世界の中でも根本的には数学的実体に過ぎないことは確認できています。

####物理世界　--コーディング（モデル化）-->　数学世界　

そして、そういう物理世界のなかの数学的要素を、数学世界にマッピングすることをモデル化といい、その具体的作業こそがコーディングなのですから、あとはその方針に従ってコーディングすれば良い、ということになります。
...
##「時間」をモデル化する具体的な方法＝「関数型（ファンクショナル）リアクティブプログラミング（FRP）」

そして実際にこの方針でモデル化、プログラミング実装する手法が、
